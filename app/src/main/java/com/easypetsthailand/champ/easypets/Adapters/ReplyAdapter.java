...
public class ReplyAdapter extends RecyclerView.Adapter<ReplyAdapter.GenericHolder> {
    ...
    public static class ViewHolder extends GenericHolder {
        ...
        public void setViewData(final Reply reply) {
            ...
            String replierPicturePath = context.getString(R.string.URL)+ context.getString(R.string.logo_bucket) + service.getLogoPath();
            ...
            //user pic
            Glide.with(context).load(replierPicturePath).centerCrop().into(cv_replier_pic);
            ...
            if(!reply.getReplyPicturePath().equalsIgnoreCase("null")){
                String imgPath = context.getString(R.string.URL)+context.getString(R.string.reply_bucket)+ reply.getReplyPicturePath();
                Glide.with(context).load(imgPath).centerCrop().into(replyImageView);
